...
class Bank(brokers: List[String])(accounts: Map[String, Account]) extends AvroAgent[Transaction](defaultConfig(brokers = brokers, agentId = AgentId("Bank")))(null) with Runnable{
