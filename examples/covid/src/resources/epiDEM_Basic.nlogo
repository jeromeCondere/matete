...
[
  ...
  ;; p-travel              ;; proportion of travellers
  global-window-travel  ;; number of ticks before the people that are supposed to travel travel
  ;; p-effective-travel ;; among the people that are travellers how much will travel
]
...
[
  ...
  travel?             ;; if the person will travel
  ready-to-travel
...
to setup-people
  ...
  [
    ...
    set travel? random-float 1 < p-travel
    set ready-to-travel false ;; at the begining no one is ready to travel
...
to need-to-travel
  ;; if traveller  + time to travel + in the population of effective travellers
  if ticks mod global-window-travel = 0 and  random-float 1 < p-effective-travel
    [
      set ready-to-travel true
      set shape "airplane"
      set color pink
  ]
...
to go
  ...
  ask turtles with [ travel? and not ready-to-travel]
    [ need-to-travel ]
...
to infect  ;; turtle procedure
   let nearby-uninfected (turtles-on neighbors)
     with [ not infected? and not cured? and not ready-to-travel ]
