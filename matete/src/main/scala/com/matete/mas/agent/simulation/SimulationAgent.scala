 ...
 */
abstract class SimulationAgent[T](configuration: AgentConfig)( defaultSerializer: Option[String] = None, defaultDeserializer: Option[String] = None)extends Agent[T](configuration)(defaultSerializer, defaultDeserializer)  {
